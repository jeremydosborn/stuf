...
Early. Core architecture is in place. The first TUF profile is implemented. The embedded no-heap verifier profile is working and covered by CI. A smaller, maximally constrained bare metal profile is planned.
